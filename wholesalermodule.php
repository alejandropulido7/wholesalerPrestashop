...
class WholesalerModule extends Module
{
    ...
    */
    public function installBD()
    {
        ...
        $sql[1] = 'INSERT INTO `'. _DB_PREFIX_ .'_group_lang` (`id_group`, `id_lang`, `name`) VALUES (99, 1, `Mayorista`);';
        $sql[2] = 'INSERT INTO `'. _DB_PREFIX_ .'_group_lang` (`id_group`, `id_lang`, `name`) VALUES (99, 2, `Mayorista`);';
        $sql[3] = 'INSERT INTO `'. _DB_PREFIX_ .'_group_shop` (`id_group`, `id_shop`) VALUES (99, 1);';
        $sql[4] = 'INSERT INTO `'. _DB_PREFIX_ .'_ps_group` (`id_group`, `reduction`, `price_display_method`, `show_prices`, `date_add`, `date_upd`) VALUES (99, `0`, `0`, `0`, sysdate(), sysdate());';
    ...
    {
        Db::getInstance()->execute('DROP TABLE IF EXISTS '._DB_PREFIX_. $this-> name .'_mayoristas');
